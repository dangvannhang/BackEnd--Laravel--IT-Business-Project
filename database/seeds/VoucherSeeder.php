...
class VoucherSeeder extends Seeder
{
    ...
    public function run()
    {
        // id_photographer 0 ở đây có nghĩa là nó có thể dùng để áp mã vào tất cả các booking
        // chứ không riêng gì booking với một photographer nhất định  nào đó
        ...
        DB::table('voucher')->insert([
            ...
            [
                ...
                'count' => 12,
                'denomination' => 30,                'id_photographer' => 0,
